	<!-- discover-module section
		...
		<section class="discover discover-best">
			<div class="container">
				...
				<form class="discover__form discover-elegant__form">
		...
		<!-- services-block
			================================================== -->
		<section class="services services-bgmap">
			<div class="container">
		...
		<!-- statistic-block
			================================================== -->
		<section class="statistic statistic-bg-img2">
			<div class="container">
					...
					<div class="owl-carousel" data-num="3">
						...
						<div class="item">
							...
							<div class="testimonial-post">
								...
								<h2 class="testimonial-post__title testimonial-post__title-white">
									Michael Osborne
								</h2>
